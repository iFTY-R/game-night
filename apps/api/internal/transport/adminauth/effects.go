// Package adminauth assembles administrator authentication transport state around the admin security domain.
package adminauth
...
func (effects *CookieEffects) SetAdminChallenge(header responseHeaderWriter, issued admin.IssuedChallenge) error {
...
func (effects *CookieEffects) SetAdminSession(header responseHeaderWriter, issued admin.IssuedSession) error {
...
func (effects *CookieEffects) ClearAdminSession(header responseHeaderWriter) error {
